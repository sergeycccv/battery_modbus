...
class Ui_SettingsPortWindow(object):
    def setupUi(self, SettingsPortWindow):
        ...
        self.cb_parity.setGeometry(QRect(111, 152, 131, 22))
        ...
        self.edit_stop_bits = QLineEdit(self.centralwidget)
        self.edit_stop_bits.setObjectName(u"edit_stop_bits")
        self.edit_stop_bits.setGeometry(QRect(152, 110, 90, 22))
        self.edit_byte_size = QLineEdit(self.centralwidget)
        self.edit_byte_size.setObjectName(u"edit_byte_size")
        self.edit_byte_size.setGeometry(QRect(152, 70, 90, 22))
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(32, 72, 111, 16))
        self.edit_baud_rate = QLineEdit(self.centralwidget)
        self.edit_baud_rate.setObjectName(u"edit_baud_rate")
        self.edit_baud_rate.setGeometry(QRect(152, 29, 90, 22))
    ...
    def retranslateUi(self, SettingsPortWindow):
        ...
        self.edit_stop_bits.setText(QCoreApplication.translate("SettingsPortWindow", u"1", None))
        self.edit_byte_size.setText(QCoreApplication.translate("SettingsPortWindow", u"8", None))
        self.label_3.setText(QCoreApplication.translate("SettingsPortWindow", u"\u0411\u0438\u0442\u044b \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.edit_baud_rate.setText(QCoreApplication.translate("SettingsPortWindow", u"9600", None))
    # retranslateUi
