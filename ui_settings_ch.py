...
"}")
        ...
        self.edit_UstopDischarge = QLineEdit(self.frame)
        self.edit_UstopDischarge.setObjectName(u"edit_UstopDischarge")
        self.edit_UstopDischarge.setGeometry(QRect(130, 125, 113, 22))
        ...
        self.edit_IstopCharge = QLineEdit(self.frame)
        self.edit_IstopCharge.setObjectName(u"edit_IstopCharge")
        self.edit_IstopCharge.setGeometry(QRect(130, 165, 113, 22))
        self.edit_IstopCharge.setInputMask(u"0.000")
        self.edit_IstartDischarge = QLineEdit(self.frame)
        self.edit_IstartDischarge.setObjectName(u"edit_IstartDischarge")
        self.edit_IstartDischarge.setGeometry(QRect(130, 87, 113, 22))
